...
func (suite *SimTestSuite) TestSimulateMsgSend() {
	...
	suite.Require().Equal("32668871stake", msg.Amount.String())
...
func (suite *SimTestSuite) TestSimulateMsgMultiSend() {
	...
	require.Equal("cosmos1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.Outputs[0].Address)
	require.Equal("3831435stake", msg.Outputs[0].Coins.String())
	require.Equal("cosmos1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Outputs[1].Address)
	require.Equal("53643543stake", msg.Outputs[1].Coins.String())
